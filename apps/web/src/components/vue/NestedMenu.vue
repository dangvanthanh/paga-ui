	...
	<Teleport to="body">
		<div v-bind="fileMenu.getPositionerProps()">
			<ul v-bind="fileMenu.getContentProps()" :class="styles.content">
				<li
					v-bind="fileMenu.getItemProps({ value: 'new-file' })"
					:class="styles.item"
				>
					New file
				</li>
				<li
					v-bind="fileMenu.getItemProps({ value: 'new-win' })"
					:class="styles.item"
				>
					New window
				</li>
				...
				<li
					v-bind="fileMenu.getItemProps({ value: 'print' })"
					:class="styles.item"
				>
					Print
				</li>
				<li
					v-bind="fileMenu.getItemProps({ value: 'help' })"
					:class="styles.item"
				>
					Help
				</li>
	...
	<Teleport to="body">
		<div v-bind="shareMenu.getPositionerProps()">
			<ul v-bind="shareMenu.getContentProps()" :class="styles.content">
				<li
					v-bind="shareMenu.getItemProps({ value: 'messages' })"
					:class="styles.item"
				>
					Messages
				</li>
				<li
					v-bind="shareMenu.getItemProps({ value: 'airdrop' })"
					:class="styles.item"
				>
					Airdrop
				</li>
				<li
					v-bind="shareMenu.getItemProps({ value: 'whatsapp' })"
					:class="styles.item"
				>
					WhatsApp
				</li>
