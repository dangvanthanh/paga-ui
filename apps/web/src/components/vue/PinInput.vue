...
<template>
  <div ref="ref" v-bind="api.rootProps" :class="pinInputClasses.root">
    <input v-bind="api.getInputProps({ index: 0 })" :class="pinInputClasses.input" />
    <input v-bind="api.getInputProps({ index: 1 })" :class="pinInputClasses.input" />
    <input v-bind="api.getInputProps({ index: 2 })" :class="pinInputClasses.input" />
  </div>
</template>
